...
class WordBonusManager {
  ...
  static final Set<String> _defaultDictionary = {
    ...
    'ބަނބު', 'ކައް', 'ދަނޑު', 'މަގު', 'ފާރު', 'ފުރާ', 'ކުޑަ', 'ބާލި', 'ގޮނޑި',
    'މޭޒު', 'ދޮރު', 'ކުޑަ', 'ފެން', 'ކަރަ', 'ފޮތް', 'ގަލަ', 'ކަނި', 'ވައި',
    'ބައް', 'ކަނު', 'ފަރު', 'ވިލު', 'ފިނޮ', 'ހުރާ', 'ކުޅި', 'ގޮއި', 'ގިރި',
    'ފަޅު', 'ނެރު', 'ތުނޑި', 'އެރު', 'ބެހު', 'ފޮނު', 'ތޫފާ', 'ޖެހި', 'ވެއް',
    'ގިނަ', 'ބާރު', 'ނެތް', 'އެބަ', 'ނުވެ', 'ވާނެ', 'ކުރި', 'ފެށި', 'ނިމު',
